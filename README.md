...
Requer Python 3.10 ou mais recente. No Windows, use preferencialmente
`setup.bat`: ele procura explicitamente Python 3 e não usa um eventual Python 2
associado ao comando `python`.
